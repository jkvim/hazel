...
const { valid, compare, gt } = require('semver')
...
module.exports = ({ cache, config }) => {
  ...
  exports.download = async (req, res) => {
    ...
    console.log('download platforms', platforms)
  ...
  exports.downloadPlatform = async (req, res) => {
    ...
    if (shouldProxyPrivateDownload) {
      console.log('proxyPrivateDownload', latest.platforms[platform])
  ...
  exports.update = async (req, res) => {
    ...
    console.log('shouldProxyPrivateDownload', shouldProxyPrivateDownload)
    console.log('latest.version', latest.version)
    console.log('version', version)
    console.log('gt(latest.version, version)', gt(latest.version, version))
